    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createSapiForm" method="POST" action="{{route('save-layanan-admin')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<div class="modal fade" id="editModal-{{ $item['id'] }}" tabindex="-1" aria-labelledby="editModalLabel-{{ $item['id'] }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('update-layanan-admin', $item['id']) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Layanan</label>
            ...
            @forelse ($layanan as $index => $item)
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <form action="{{ route('destroy-layanan-admin', $item['id']) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
